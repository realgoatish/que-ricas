...
export default {
    ...
    data () {
      return {
        link: 'mailto: quericas2019@gmail.com',
        a11yTitle: "Click to email Que Ricas your questions or comments"
      }
    }
}
